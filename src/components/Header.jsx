  ...
  return (
    <div className="relative bg-gradient-to-r from-green-300 via-white to-green-300 dark:from-green-900 dark:via-green-900 dark:to-green-800 transition-colors duration-300">
      <div className="container mx-auto px-6 pt-6 pb-24 relative z-20">
        ...
        <div className="flex justify-between items-center mb-10">
          ...
          <div className="flex items-center gap-6">
            ...
            <button 
              onClick={toggleTheme}
              className={`relative h-8 w-16 rounded-full transition-colors duration-300 focus:outline-none focus:ring-2 focus:ring-green-400 focus:ring-offset-2 ${
                theme === 'dark' ? 'bg-green-950' : 'bg-black/10 hover:bg-black/20'
              }`}
              aria-label="Toggle Dark Mode"
            >
              <div
                className={`absolute top-1 left-1 h-6 w-6 rounded-full bg-white shadow-md transform transition-transform duration-300 flex items-center justify-center ${
        ...
        <div className="flex justify-center mb-8">
          <div className="relative w-full max-w-2xl">
            <input
              ...
              className="w-full pl-14 pr-6 py-4 rounded-full border-none text-gray-700 placeholder-gray-400 shadow-2xl focus:ring-4 focus:ring-green-400/30 bg-white/95 dark:bg-gray-800 dark:text-white dark:placeholder-gray-400 backdrop-blur-sm transition-colors duration-300"
            />
      ...
      <div className="absolute bottom-0 left-0 w-full overflow-hidden leading-none z-10">
        <svg 
          className="relative block w-full h-16 sm:h-24 text-gray-50 dark:text-gray-900 transition-colors duration-300" 
