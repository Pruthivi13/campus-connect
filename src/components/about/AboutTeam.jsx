...
export default function AboutTeam() {
    ...
    useEffect(() => {
        // Mobile tap support for flip cards
        const cards = document.querySelectorAll('.about-flip-card');
        const handleClick = (e) => {
            const card = e.currentTarget;
            const inner = card.querySelector('.about-flip-inner');
        ...
        <section className="about-team">
            ...
            <div className="about-team-grid">
                {teamMembers.map((member) => (
                    <div key={member.id} className="about-flip-card">
                        <div className="about-flip-inner">
                                ...
                                <div className="about-team-card">
                                    ...
                                    <div className="about-content">
                                        ...
                                        <div className="about-actions">
                                            <button className="about-connect-btn">Connect</button>
                            ...
                            <div className="about-flip-back">
                                <img src={member.image} alt={member.name} className="about-portrait" />

                                <div className="about-bubble right">
                                    <strong>{member.greeting}</strong><br />
                                    Role: {member.name.split(' ')[0]}<br />
                                    Skill set: {member.skills}
                                </div>

                                <div className="about-bubble left small">
                                    {member.personality}
                                </div>
