...
const NoticeBoardTicker = () => {
  ...
  return (
    <div className="w-full max-w-4xl mx-auto mb-8 px-4 relative z-20">
      <div 
        className="bg-white/90 dark:bg-gray-800/90 backdrop-blur-md rounded-full shadow-lg py-3 px-4 flex items-center justify-between border border-gray-100 dark:border-gray-700 transition-colors duration-300"
