          ...
          <div className="flex flex-col gap-6">
            ...
            <div className="relative w-full">
              ...
              <input
                ...
                className="w-full pl-12 pr-4 py-3 rounded-xl border-2 border-green-500/50 hover:border-green-500 focus:border-green-500 bg-white dark:bg-gray-700 text-gray-800 dark:text-white focus:outline-none transition-all"
                value={searchTerm}
